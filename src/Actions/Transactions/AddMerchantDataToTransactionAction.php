...
class AddMerchantDataToTransactionAction extends Action
{
    public Method $method = Method::POST;

    public string $endpoint = 'transactions/{id}/addMeta';

    public const SCHEMA_NAME = 'AddMerchantDataToTransactionSchema.json';
